...
@Component({
  selector: 'app-modal-change-project-role',
  standalone: true,
    ...
    <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-2xl z-[1001] w-[500px] max-w-[95vw] overflow-hidden">
      ...
      <div class="bg-gradient-to-r from-primary-50 to-primary-100 px-6 py-5 border-b border-primary-200">
        <div class="flex items-center gap-3">
          ...
          <h3 class="text-2xl font-bold text-gray-800">Cambiar Rol en Proyecto</h3>
        </div>
      </div>
      ...
      <div class="px-6 py-6">
        ...
        <div class="mb-5 p-4 bg-gray-50 rounded-lg">
          ...
          <p class="text-sm text-gray-600 mt-2">Rol actual en proyecto</p>
          <p class="font-semibold text-primary-600">{{ currentRole }}</p>
        </div>

        <!-- Seleccionar nuevo rol -->
        <div class="mb-6">
          <label class="block text-sm font-semibold text-gray-700 mb-2">
            Nuevo Rol en Proyecto <span class="text-red-500">*</span>
          </label>
          <select
...
export class ModalChangeProjectRoleComponent implements OnInit {
  ...
  availableRoles = [RolProyecto.LIDER, RolProyecto.EMPLEADO, RolProyecto.CLIENTE];
